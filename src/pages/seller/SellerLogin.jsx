...
const SellerLogin = ({ onBack, onLoginSuccess, onGoToRegister }) => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // Vergi No'yu username olarak gönderiyoruz
            ...
            if (data.role === 'merchant' || data.role === 'seller') {
                localStorage.setItem("user", JSON.stringify(data));
                onLoginSuccess({ name: data.username || data.name, role: 'seller', id: data.id, balance: data.balance });
            } else {
                setError('Bu hesap İşletme/Satıcı rolünde değil.');
                setLoading(false);
            }
        } catch (err) {
            ...
            <div className="login-card" style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    <p className="subtitle" style={{ 
                        ...
                        <i className="fas fa-store" style={{ marginRight: '8px', color: currentTheme.accent }}></i>
                        İşletme / Şirket Girişi
                    </p>
                    ...
                    >
                        ...
                        İnteraktif Vergi Dairesi ile Giriş
                    </button>
                    ...
                    <div className="divider" style={{ 
                        ...
                        <span style={{ background: 'white', padding: '0 15px', position: 'relative', zIndex: 1 }}>
                            veya kayıtlı bilgilerinizle
                        </span>
                        <div style={{
                            position: 'absolute',
                            top: '50%',
                    ...
                    <form onSubmit={handleLogin}>
                        <div className="input-group" style={{ marginBottom: '20px' }}>
                            <label style={{
                                ...
                                <i className="fas fa-id-card" style={{ marginRight: '8px', color: currentTheme.accent }}></i>
                                Vergi Numarası
                            </label>
                            <input 
                                type="text" 
